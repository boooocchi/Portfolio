...
import work from "@/assets/project.jpg";
import { motion, useScroll } from "framer-motion";
import smartRecipe from "../assets/smartRecipe.jpg";
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="aspect-[5/6] group/item transition z-[1] duration-1000 items-end relative overflow-hidden  shadow-sm before:content-[''] before:z-[1] before:hover:scale-[1.3] before:bg-[url('@/assets/smartRecipe.jpg')] before:h-[110%] before:bg-cover before:w-full before:absolute before:top-0 before:left-0 hover:before:translate-y-[-5%] hover:before:transition hover:before:duration-500 before:bg-bottom h-[350px] hover:items-center p-[1rem] before:transition before:duration-500 after:content-[''] after:block after:absolute after:top-0 after:left-0 after:w-full after:h-[200%] after:bg-gradient-to-b after:from-[rgba(0,0,0,0.2)] after:to-[rgba(0,0,0,0.6)] after:z-[10] after:hover:translate-y-[-50%]">
