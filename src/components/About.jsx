...
const About = () => {
  return (
    <motion.section
      ...
      className="about w-8/12 max-md:w-[80%] mx-auto mt-24 mb-20 max-w-[1000px] flex max-md:flex-col gap-[5%]"
      id="about"
    >
      <div className="w-[55%] max-md:w-full text-[1.2rem] font-thin leading-[2rem]">
